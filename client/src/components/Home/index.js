    ...
    return (
        <>
            ...
            <div className="flex flex-col bg-[#00050d]">
                ...
                {/* Categories */}
                <ul className="list-none m-0 px-[50px] py-[10px]">
                    {HomeCategories.map((eachCategory) => (
                        <li key={eachCategory.id} className="mt-[30px]">
                            <p className="text-[25px] font-medium text-[#a9a9a9] m-0 relative z-0">
                                {eachCategory.category}
                            </p>
                            <Category
                                movieIds={eachCategory.movieIds}
                                isMovie={eachCategory.id <= 5}
                            />
                        </li>
                    ))}
                </ul>
